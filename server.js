...
app.post('/api/generate-question', async (req, res) => {
    ...
    // Note: Groq's Llama 3 doesn't process images (vision) natively yet, 
    // so we just pass the text prompt.
    try {
...
// Catch-all route
app.use((req, res) => { res.sendFile(path.join(__dirname, 'interview.html')); });

const PORT = process.env.PORT || 3000;
app.listen(PORT, () => console.log(`🚀 SSB Local Server running at http://localhost:${PORT}`));