...
def get_ai_summary(text):
    ...
    # The prompt requests a detailed 60-word summary
    prompt = f"""
...
def fetch_and_process_news():
    ...
    try:
        ...
        for article in news_data['articles']:
            ...
            url = article.get('url')
            # 2. Get the individual article date
            ...
            if ai_result and ai_result.get('summary') and ai_result.get('category'):
                formatted_article = {
                    ...
                    "date": article_date, # This is the publication date of the specific article
                }
        ...
        # 3. Create the final data structure with the timestamp
        final_json_data = {
